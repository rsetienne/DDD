...
values where the diversity-dependent dynamics of an innovative subclade
have different parameters from the dynamics of the main clade from time
t_d, but both are governed by the same carrying capacity and experience
...
- pars2:
  ...
  age (2) `pars2[7]` sets whether the old (incorrect) likelihood should
  be used (0) or whether new corrected version should be used (1)
