...
#' @param age the total simulation time
#' @param model the model used in the simulation
#' @param EDPars the ED related parameters used in simulation being plotted
#' @param EDModel the ED model used in the simulation
#' @param EDMethod the method of ED being used in the simulation
#' @return a plot grid generated by cow_plot
#' @author Tianjian Qin
#' @keywords phylogenetics
